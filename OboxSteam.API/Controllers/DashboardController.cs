...
public class DashboardController : ControllerBase
{
    ...
    [HttpGet("overview")]
    [SwaggerOperation(
        Summary = "Manager dashboard landing KPIs",
        Description = "Returns trimmed KPI summaries for revenue, enrollment, assessment, and operations. Status filters that do not apply to a section are ignored.")]
